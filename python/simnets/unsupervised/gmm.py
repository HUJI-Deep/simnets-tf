...
def gmm_unsupervised_init(sim_op, templates_var, weights_var):
    ...
    with tf.name_scope(name):
        ...
        _, _, _, training_op = _gmm(inp=patches, initial_clusters='random', random_seed=33,
                                    num_clusters=ninstances, covariance_type='diag', params='mc')
        ...
        reshaped_covs = tf.reshape(clusters_covs, (ninstances, block_rows, block_cols, channels))
        ...
        return tf.no_op(), tf.group(assign1, assign2, name='kmeans_init_assign')
