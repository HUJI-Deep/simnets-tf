...
namespace simnets_tf {
    ...
    // Taken from caffe/util/device_alternae.hpp
...
#define CUDA_POST_KERNEL_CHECK CUDA_CHECK(cudaPeekAtLastError())
    ...
    void im2col_gpu(const Dtype* data_im, const int channels,
        ...
        im2col_gpu_kernel<Dtype><<<SIMNETS_TF_GET_BLOCKS(num_kernels),
                SIMNETS_TF_CUDA_NUM_THREADS>>>(
...
// Explicit instantiation
    ...
    void im2col_nd_gpu(const Dtype* data_im, const int num_spatial_axes,
        ...
        // TODO: Make this test active
        // DCHECK_LT(num_spatial_axes, SIMNETS_TF_CUDA_NUM_THREADS);
        switch (num_spatial_axes) {
            case 1:
                im2col_nd_gpu_kernel<Dtype, 1>  // NOLINT_NEXT_LINE(whitespace/operators)
                        <<<SIMNETS_TF_GET_BLOCKS(num_kernels), SIMNETS_TF_CUDA_NUM_THREADS>>>(
...
// Explicit instantiation
    ...
    void col2im_gpu(const Dtype* data_col, const int channels,
        ...
        // NOLINT_NEXT_LINE(whitespace/operators)
        col2im_gpu_kernel<Dtype><<<SIMNETS_TF_GET_BLOCKS(num_kernels),
                SIMNETS_TF_CUDA_NUM_THREADS>>>(
        ...
        switch (num_spatial_axes) {
            case 1:
                col2im_nd_gpu_kernel<Dtype, 1>  // NOLINT_NEXT_LINE(whitespace/operators)
                        <<<SIMNETS_TF_GET_BLOCKS(im_size), SIMNETS_TF_CUDA_NUM_THREADS>>>(
...
// 3D Convolutions
    ...
    void im2col_3d_gpu(const Dtype* data_im,
        ...
        // NOLINT_NEXT_LINE(whitespace/operators)
        im2col_3d_gpu_kernel<Dtype><<<SIMNETS_TF_GET_BLOCKS(num_kernels),SIMNETS_TF_CUDA_NUM_THREADS>>>(
                num_kernels, data_im,
    ...
    void col2im_3d_gpu(const Dtype* data_col,
        ...
        // NOLINT_NEXT_LINE(whitespace/operators)
        col2im_3d_gpu_kernel<Dtype><<<SIMNETS_TF_GET_BLOCKS(num_kernels), SIMNETS_TF_CUDA_NUM_THREADS>>>(
