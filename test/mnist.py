...
def _similarity_grad(op, grad):
    ...
    grad_input = similarity_input_grad(inp, templates, weights, grad, padding=padding, blocks=blocks, strides=strides,
    ...
    grad_templates, grad_weights = similarity_parameters_grad(inp, templates, weights, grad, padding=padding, blocks=blocks, strides=strides,
                                                              similarity_function=similarity_function,
                                                              normalization_term=normalization_term, normalization_term_fudge=normalization_term_fudge,
                                                              ignore_nan_input=ignore_nan_input, out_of_bounds_value=out_of_bounds_value)
